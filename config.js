...
global.sig = 'https://www.instagram.com/katyushaclara/'
global.sgh = 'github.com' //github
global.sgc = 'https://chat.whatsapp.com/L8aLHaH7lM0FBuKiNFDjYT' //group whatsapp
global.sdc = '-' //discord
global.syt = 'https://t.me/fbi_ofc'
global.snh = 'https://t.me/fbf_c' // my youtube channel

/*============== PAYMENT ==============*/
global.pdana = '6282253479547' //dana
global.povo = '6282253479547' //ovo
global.pgopay = '6282253479547' //gopay
global.plinkaja = '6282253479547' //link aja
global.ppulsa = '082253479547' //indosat
global.pgdc = 'https://chat.whatsapp.com/L8aLHaH7lM0FBuKiNFDjYT' //group WhatsApp 
global.ppulsa2 = '-' // kalau ada kartu lain isi aja
global.psaweria = 'https://saweria.com/kitsunee928'

/*============== NOMOR ==============*/
global.nomorbot = '6285163083750'
global.nomorown = '6281347927862'
global.namebot = '⌬ Felicia-MD'
global.nameown = '么 Kitsuneee'

/*============== APIKEY SIMPEL ==============*/
global.zenzkey = 'b8040941f7'
global.lolkey = 'KitsuneOFC' // PUNYA Jarot 357d3c85079c4e0818731e6b
...
global.APIKeys = { // APIKey Here
  ...
  'https://api.lolhuman.xyz': 'KitsuneOFC',// 8e66d0934cf741bfd2182c16
...
/*============== WATERMARK ==============*/
global.wm = '⌬ Felicia-MD' //Main Watermark
global.wm2 = '©2022 | Kitsune.DV'
global.wm3 = '⌬ Felicia-MD'
global.botdate = `${week} ${date}`
global.bottime = `${wktuwib}`
global.titlebot = `©Bot WhatsApp |  v38.md`
global.author = '么 Kitsuneee'


/*============== LOGO ==============*/
global.thumb = 'https://telegra.ph/file/c0291d37db82ecae686d8.jpg' //Main Thumbnail
global.imagebot = 'https://telegra.ph/file/dc7948f31f135ebe919b5.jpg'
global.giflogo = 'https://telegra.ph/file/a46ab7fa39338b1f54d5a.mp4'
global.thumbs = ['https://telegra.ph/file/ba2cfa8f373099d0ccd65.jpg']
global.fla = 'https://telegra.ph/file/6830ca66c7bc3eed249a5.jpg'
global.flaaa2 = [
...
global.thumbdoc = 'https://telegra.ph/file/1942d288cfc5d77a594ac.jpg'

/*=========== FAKE SIZE ===========*/
global.fsizedoc = '999999999999999999999999999999999999999999999999' // default 10TB
global.fpagedoc = '444'
...
/*============== STICKER WM ==============*/
global.stickpack = 'ℹ️ 𝗔𝗕𝗢𝗨𝗧'
global.stickauth = `- 𝗠𝗮𝗱𝗲 𝗯𝘆 ⌬ FeliciaBot-MD\n- 𝗕𝗼𝘁 𝗡𝘂𝗺𝗯𝗲𝗿 6285163083750\n- 𝗦𝘁𝗶𝗰𝗸𝗲𝗿 𝗖𝗼𝗱𝗲 ${pickRandom(['1', '2', '3', '4', '5', '6', '7', '8', '9', '0', 'A', 'B','C','D','E','F','G','H','I','J','K'])}${pickRandom(['1', '2', '3', '4', '5', '6', '7', '8', '9', '0', 'A', 'B','C','D','E','F','G','H','I','J','K'])}${pickRandom(['1', '2', '3', '4', '5', '6', '7', '8', '9', '0', 'A', 'B','C','D','E','F','G','H','I','J','K'])}${pickRandom(['1', '2', '3', '4', '5', '6', '7', '8', '9', '0', 'A', 'B','C','D','E','F','G','H','I','J','K'])}${pickRandom(['1', '2', '3', '4', '5', '6', '7', '8', '9', '0', 'A', 'B','C','D','E','F','G','H','I','J','K'])}${pickRandom(['1', '2', '3', '4', '5', '6', '7', '8', '9', '0', 'A', 'B','C','D','E','F','G','H','I','J','K'])}\n- 𝗦𝘁𝗶𝗰𝗸𝗲𝗿 𝗦𝗶𝘇𝗲 ${pickRandom(['1', '2', '3', '4', '5', '6', '7', '8', '9', '0'])}${pickRandom(['1', '2', '3', '4', '5', '6', '7', '8', '9', '0'])}${pickRandom(['1', '2', '3', '4', '5', '6', '7', '8', '9', '0'])}Kb`
