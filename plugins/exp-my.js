...
`.trim()
  conn.sendButton(m.chat, `*USER INFORMATION 💽*`, caption, null, [`𝗜𝗡𝗩𝗘𝗡𝗧𝗢𝗥𝗬`, '.inv'],m)
}
handler.help = ['my']
handler.tags = ['xp']
...
function clockString(ms) {
  ...
  return [ye, ' *ʏᴇᴀʀs*', mo, ' *ᴍᴏɴᴛʜ*', d, ' *ᴅᴀʏs*', h, ' *ʜᴏᴜʀs*', m, ' *ᴍɪɴᴜᴛᴇ*', s, ' *sᴇᴄᴏɴᴅ*'].map(v => v.toString().padStart(2, 0)).join('')
}
