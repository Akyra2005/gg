...
`
`
await conn.sendButton(m.chat, caption, author, `${'𝐀𝐁𝐒𝐄𝐍𝐓 𝐋𝐈𝐒𝐓'}`, [['𝐇𝐀𝐃𝐈𝐑', `${usedPrefix}absen`], ['𝐌𝐄𝐍𝐔', `${usedPrefix}menu`]], m, { mentions: conn.parseMention(caption) })

}
handler.help = ['cekabsen']
handler.tags = ['main']
handler.command = /^(cekabsenn)$/i
handler.group = true
