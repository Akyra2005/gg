...
handler.all = async function (m) {
	...
	try {
        ...
        global.fvn = {
            ...
            message: { "liveLocationMessage": { "caption":"么 Kitsuneee","h": `${wm}`, 'jpegThumbnail': fs.readFileSync('./thumbnail.jpg')}}
           }
            ...
            participant: `0@s.whatsapp.net`, ...(m.chat ? 
            { remoteJid: "status@broadcast" } : {}) },
            message: { "liveLocationMessage": { "title": "么 Kitsuneee","h": wm, 'jpegThumbnail': fs.readFileSync('./thumbnail.jpg')}}
           }
