let handler = async (m, { conn, usedPrefix, command, text }) => {
  ...
  if(!text && !m.quoted) return conn.reply(m.chat, `Format: *${usedPrefix}${command} ${global.owner[0]}*\n@Tag/Reply User`, m)
  ...
  try {
	...
	delete global.db.data.users[user]
 	...
 	conn.sendHydrated(m.chat, anu, wm, pp, null,null, number, '𝗥𝗜𝗣', [[null,null],[null,null],[null,null]], m, {mentions: [number+'@s.whatsapp.net']})
  }
}
